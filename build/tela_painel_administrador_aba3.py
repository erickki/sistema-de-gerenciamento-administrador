...
def tela_painel_administrador_aba3(page: ft.Page):
    ...
    def carregar_dados_painel_administrador_aba3():
    ...
    colunas, dados = carregar_dados_painel_administrador_aba3()

    cabecalho_painel_administrador_aba3 = [ft.DataColumn(ft.Text(nome),
                                            heading_row_alignment=ft.MainAxisAlignment.START) for nome in colunas]
    
    dados_painel_administrador_aba3 = [ft.DataRow(cells=[ft.DataCell(ft.Text(str(campo))) for campo in linha])
                               for linha in dados]
    ...
    def atualizar_tabela():
        ...
        dados_painel_administrador_aba3 = [ft.DataRow(cells=[ft.DataCell(ft.Text(str(campo))) for campo in linha])
                                        for linha in dados]
        tabela1_painel_administrador_aba3.content = ft.DataTable(
            columns=cabecalho_painel_administrador_aba3, rows=dados_painel_administrador_aba3, border_radius=15,
    ...
    def modificar(e):
        id_selecionado = entrada1_painel_administrador_aba3.content.value
        cargo_selecionado = selecao1_painel_administrador_aba3.content.value
        banco_cadastros = os.path.join(os.path.dirname(__file__), '..', 'data', 'cadastros.db')
        banco_cadastros = os.path.abspath(banco_cadastros)
        conn = sqlite3.connect(banco_cadastros)
        cursor = conn.cursor()
    ...
    def filtrar_nomes(e):
        nome_busca = entrada1_painel_administrador_aba3.content.value.strip()
        banco_cadastros = os.path.join(os.path.dirname(__file__), '..', 'data', 'cadastros.db')
        banco_cadastros = os.path.abspath(banco_cadastros)
        conn = sqlite3.connect(banco_cadastros)
        cursor = conn.cursor()
    ...
    tabela1_painel_administrador_aba3 = ft.Container(
        content=ft.DataTable(
            columns=cabecalho_painel_administrador_aba3, rows=dados_painel_administrador_aba3, border_radius=15, column_spacing=10,
    ...
    entrada1_painel_administrador_aba3 = ft.Container(
    ...
    divisao1_painel_administrador_aba3 = ft.Container(
    ...
    entrada2_painel_administrador_aba3 = ft.Container(
        content=ft.TextField(
            text_align=ft.TextAlign.START, cursor_color=cor_branca, cursor_width=2, cursor_height=20,
    ...
    selecao1_painel_administrador_aba3 = ft.Container(
        content=ft.Dropdown(
            options=[
    ...
    botao1_painel_administrador_aba3 = ft.Container(
        content=ft.Text(
            value="Modificar", text_align=ft.TextAlign.CENTER, font_family=fonte, size=14,
    ...
    divisao2_painel_administrador_aba3 = ft.Container(
        content=ft.VerticalDivider(
            width=0, thickness=2, color=cor_branca
        ),
        alignment=ft.alignment.center,
    ...
    botao2_painel_administrador_aba3 = ft.Container(
        content=ft.Text(
    ...
    fundo1_painel_administrador_aba3 = ft.Container(
        content=ft.Column(
            [
                tabela1_painel_administrador_aba3
            ],
    ...
    fundo2_painel_administrador_aba3 = ft.Container(
        content=ft.Row(
            [
                entrada1_painel_administrador_aba3,
                divisao1_painel_administrador_aba3,
                entrada2_painel_administrador_aba3,
                selecao1_painel_administrador_aba3,
                botao1_painel_administrador_aba3,
                divisao2_painel_administrador_aba3,
                botao2_painel_administrador_aba3
            ],
            alignment=ft.MainAxisAlignment.CENTER,
    ...
    tela_atual = ft.Container(
        content=ft.Column(
            [
                fundo1_painel_administrador_aba3,
                fundo2_painel_administrador_aba3
            ],
            alignment=ft.MainAxisAlignment.CENTER,
            horizontal_alignment=ft.CrossAxisAlignment.CENTER
        ),
...
#ft.app(target=tela_painel_administrador_aba3)